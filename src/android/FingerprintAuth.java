...
public class FingerprintAuth extends CordovaPlugin {
  ...
  public boolean multitasking = false;
  ...
  public boolean execute(final String action, JSONArray args, CallbackContext callbackContext)
    ...
    if (mAction != null) {
      ...
      if (mAction != PluginAction.AVAILABILITY && mAction != PluginAction.STOP) {
              ...
              cordova.getActivity().runOnUiThread(new Runnable() {
                public void run() {
                  ...
                  if (initCipher()) {
                    ...
                    mFingerPrintHelper = new FingerPrintHandler(mContext);
